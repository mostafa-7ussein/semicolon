        ...
        stage('Run Ansible Playbook') {
            steps {
                script {
                    ...
                    sh "ansible-playbook -i 172.167.142.78, semi-colon.yml --extra-vars 'target_host=172.167.142.78' --user azureuser --private-key ./id_rsa -e 'ansible_ssh_common_args="-o StrictHostKeyChecking=no"'"
                // }
                    }   
